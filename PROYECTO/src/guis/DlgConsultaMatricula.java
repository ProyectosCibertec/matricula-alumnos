...
public class DlgConsultaMatricula extends JDialog implements ActionListener, KeyListener, WindowListener {
	...
	protected void actionPerformedButton(ActionEvent e) {
		...
		if(matricula != null) {
			textArea.setText("");
			imprimir("******************************************************************");
			imprimir("Código del alumno es: 		" + ArregloAlumno.buscar(matricula.getCodAlumno()).getCodAlumno());
			...
			imprimir("------------------------------------------------------------------");
			imprimir("Código del curso es: 		" + ArregloCurso.buscar(matricula.getCodCurso()).getCodCurso());
			...
			imprimir("Créditos del curso son: 	" + ArregloCurso.buscar(matricula.getCodCurso()).getCreditos());
