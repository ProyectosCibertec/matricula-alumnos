...
public class DlgConsultaAlumno extends JDialog implements ActionListener, KeyListener, WindowListener {
	...
	protected void actionPerformedButton(ActionEvent e) {
		...
		if(alumno != null) {
			textArea.setText("");
			imprimir("******************************************************************");
			imprimir("Código del alumno:		" + alumno.getCodAlumno());
				...
				for(int i = 0; i < ArregloCurso.tamaño(); i++) {
					for(int j = 0; j < ArregloMatricula.tamaño(); j++){
						if(ArregloCurso.obtener(i).getCodCurso() == ArregloMatricula.obtener(j).getCodCurso()) {
							imprimir("Código del curso es: 		" + ArregloCurso.obtener(i).getCodCurso());
							...
							imprimir("Créditos del curso son: 	" + ArregloCurso.obtener(i).getCreditos());
